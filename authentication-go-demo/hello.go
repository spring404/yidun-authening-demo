...
const (
	apiURL     = "http://127.0.0.1:8015/v1/idcard/check"
	version    = "v1"
	secretID   = "" //产品密钥ID，产品标识
	secretKey  = "" //产品私有密钥，服务端生成签名信息使用，请严格保管，避免泄露
	businessID = "" //业务ID，易盾根据产品业务特点分配
)
...
func main() {
	params := url.Values{
		"name":   []string{"陆要"},
		"cardNo": []string{"341622199408144317"},
	}
